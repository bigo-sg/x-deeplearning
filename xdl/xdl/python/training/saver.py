...
class Saver(object):
    ...
    def save(self, version, save_mode = 0x01, click_show_threshold = -1.0):
        execute(self.save_op(version, save_mode, click_show_threshold))
    def restore(self, version):
        execute(self.restore_op(version))
    def save_op(self, version, save_mode, click_show_threshold):
        return xdl.ps_save_op(_string_to_int8(version), save_mode, click_show_threshold)
